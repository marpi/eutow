var BG = function () {
    ...
    function init() {
        ...
        cubeMaterial = new THREE.MeshBasicMaterial({
            envMap: Assets.getCubeMap(12),
            //opacity:.3,//.75,
            //transparent:true,
            //map: new THREE.TextureLoader().load("textures/archan2reflection.jpg"),
            fog: false,
        ...
        cubeMesh = new THREE.Mesh(new THREE.SphereGeometry(600, 12, 13), cubeMaterial);
        cubeMesh.scale.x = -1
        cubeMesh.scale.z = -1
